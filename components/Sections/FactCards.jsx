            ...
            return (
              ...
              >
                <a href={`#${index}-fact-snippet-card`}>
                  <div className="py-12 px-10 rounded-lg bg-white group-hover:bg-indigo-800 transition hover:ease-in ease-out duration-300">
                    ...
                    <h3 className="mb-4 h-36 text-3xl leading-tight md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight font-bold font-heading group-hover:text-white transition hover:ease-in ease-out duration-300">
                      {title}
                    </h3>
